...
import com.example.proyfinalandroid.Activity.CambiarPassword;
import com.example.proyfinalandroid.Activity.EditarPerfil;
import com.example.proyfinalandroid.Activity.Login;
import com.example.proyfinalandroid.Fragments.Principal.Post.PostAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.codigoFuente:
                Uri uri = Uri.parse("https://github.com/magomela/ProyectoAndroidArea51");
